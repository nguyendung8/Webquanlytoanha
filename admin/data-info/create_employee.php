    ...
    if (mysqli_num_rows($check_email) > 0) {
        ...
        try {
            ...
            $insert_staff = mysqli_query($conn, "
                INSERT INTO Staffs (ID, Name, Email, PhoneNumber, Position, DepartmentId, Address, NationalID, Status) 
                VALUES ('$employee_id', '$fullname', '$email', '$phone', '$position', '$department', '$address', '$national_id', 'active')
