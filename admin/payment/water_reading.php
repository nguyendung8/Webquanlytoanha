...
$drop_fk_sql = "
    ...
    DROP FOREIGN KEY IF EXISTS watermeterreading_ibfk_1,
    DROP FOREIGN KEY IF EXISTS watermeterreading_ibfk_2;
...
if(isset($_POST['save_reading'])) {
    try {
        ...
        $sql = "INSERT INTO WaterMeterReading (
            InitialReading, 
            FinalReading, 
            Image, 
            ClosingDate, 
        ...
        header('Location: water_reading.php?success=1');
        exit();
...
if(isset($_POST['delete_reading'])) {
    ...
    $delete_sql = "DELETE FROM WaterMeterReading WHERE WaterMeterID = ?";
...
if(isset($_POST['update_reading'])) {
    try {
        ...
        $update_sql = "UPDATE WaterMeterReading SET FinalReading = ?, Consumption = ? WHERE WaterMeterID = ?";
...
if (isset($_GET['delete_success'])) {
    $success_msg = "Xóa chỉ số nước thành công!";
}
if (isset($_GET['update_success'])) {
    $success_msg = "Cập nhật chỉ số nước thành công!";
}

// Hiển thị thông báo thành công nếu có
if (isset($_GET['success'])) {
    $success_msg = "Thêm chỉ số nước thành công!";
}
...
$query = "SELECT w.*, a.Code as ApartmentCode, a.Name as ApartmentName, s.Name as StaffName 
          FROM WaterMeterReading w
          LEFT JOIN apartment a ON w.ApartmentID = a.ApartmentID
          LEFT JOIN Buildings b ON a.BuildingId = b.ID
          LEFT JOIN staffs s ON w.StaffID = s.ID
...
<body>
        ...
        <div style="width: 100%;">
            ...
            <div class="container-fluid p-4">
               ...
               <div class="page-header mb-4">
                    <h2 style="font-weight: bold; color: #476a52; margin-bottom: 10px; text-transform: uppercase;">QUẢN LÝ CHỈ SỐ NƯỚC</h2>
                ...
                <a href="./electric_reading.php" class="tab-item">Chỉ số điện</a>
                <a href="./water_reading.php" class="tab-item active">Chỉ số nước</a>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(empty($selected_project)): ?>
                                        <button class="btn btn-link text-primary" onclick="showProjectAlert()">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="btn btn-link text-danger" onclick="showProjectAlert()">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <button class="btn btn-link text-danger" onclick="deleteReading(<?php echo $row['WaterMeterID']; ?>)">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                    <?php endif; ?>
                                </td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="addReadingForm" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        <label class="form-label">Hình ảnh chỉ số nước <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="Nước" readonly>
                                        </div>
                                        <div class="col-md-6">
                ...
                <div class="modal fade" id="viewReadingModal" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Chi tiết chỉ số nước</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
    ...
    function getInitialReading() {
        ...
        if (apartmentId && closingMonth) {
            ...
            fetch(`water_reading.php?action=get_last_reading&apartment_id=${apartmentId}&month=${previousMonth}`)
    ...
    function updateApartmentList(projectId) {
        ...
        if(projectId) {
            fetch(`water_reading.php?action=get_apartments&project_id=${projectId}`)
                .then(response => response.json())
                .then(data => {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Khởi tạo danh sách căn hộ nếu đã có dự án được chọn
        const initialProject = projectSelect?.value;
        if(initialProject) {
            updateApartmentList(initialProject);
        }
    });
