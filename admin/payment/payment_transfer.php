...
$where_conditions = ["(r.PaymentMethod = 'Chuyển khoản' OR p.PaymentMethod = 'Chuyển khoản')"];
...
$query = "
    ...
    FROM (
        ...
        FROM receipt 
        WHERE PaymentMethod = 'Chuyển khoản'
        UNION ALL
        SELECT 
            ApartmentID, 
            AccountingDate, 
...
<head>
    ...
    <title>Báo cáo thu phí bằng chuyển khoản</title>
        ...
        <div class="flex-grow-1">
            ...
            <div class="container-fluid p-4">
                ...
                <div class="page-header">
                    <h2 class="text-uppercase fw-bold" style="color: #476a52;">Báo cáo thu phí bằng chuyển khoản</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Báo cáo thu phí bằng chuyển khoản</li>
                        </ol>
                    </nav>
                </div>
