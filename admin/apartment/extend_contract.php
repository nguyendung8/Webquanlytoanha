                ...
                <div class="form-container">
                    <form action="" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contract_code" class="form-control" value="<?php echo $contract_data['ContractCode']; ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Mã phụ lục hợp đồng</label>
                                    <input type="text" name="appendix_code" class="form-control" value="<?php echo $contract_data['ContractCode'].'-PL'.date('Ymd'); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="btn-container">
                            <button type="submit" name="submit" class="btn btn-success">Gia hạn</button>
